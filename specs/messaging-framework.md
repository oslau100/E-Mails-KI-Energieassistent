...
- strukturelle Vielfalt über Sequenzen (nicht immer "kurze Frage/kurzer Check")
- keine Fake-Dringlichkeit, kein Ticket-/Support-Sound

## Preheader-Regeln (final)
- ergänzt den Betreff inhaltlich
- erhöht Relevanz und Kontext
- stärkt den Grund, warum die Person diese Mail erhält
- kein Fake-Service-/Fake-Waiting-Frame

## Conversion Bridge Rule (mandatory)
- Vermeide pauschale Beruhigungsfloskeln, die Aufschub fördern.
- Nutze stattdessen logikbasierte Brücken: Konsequenz sichtbar machen, Vergleichslogik, schneller nächster Schritt.
