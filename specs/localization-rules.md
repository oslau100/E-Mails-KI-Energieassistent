...
## Bridge-sentence localization rule
- Do not localize generic reassurance scripts as default bridges.
- Prefer short logic-driven bridges (comparison, consequence, practical next step).
